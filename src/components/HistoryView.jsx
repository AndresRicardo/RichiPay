...
function HistoryView({ isOpen, onClose, onNavigateToMonth }) {
	...
	const shouldShowObligation = useObligationsStore(
		(state) => state.shouldShowObligation,
	);
								...
								>
									<div className="flex justify-between items-center mb-2">
										...
										<span className="text-sm text-gray-500">
											{summary.totalObligations} obligación
											{summary.totalObligations !== 1 ? "es" : ""}
										</span>
									</div>
									...
									<div className="mt-2 flex justify-between text-xs text-gray-500">
										...
										<span>
											...
											<span className="text-amber-600 font-medium">
												${summary.pendingAmount.toLocaleString("es-CO")}
											</span>
										</span>
									</div>
								</div>
